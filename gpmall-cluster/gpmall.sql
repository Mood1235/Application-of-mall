...
CREATE TABLE `tb_dict`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dict` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `type` int(1) NULL DEFAULT NULL COMMENT '1扩展词 0停用词',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_member` VALUES (67, 'xhd', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, '2019-10-04 06:48:59', '2019-10-04 06:48:59', NULL, NULL, 1, NULL, NULL, NULL, NULL, 'N');
...
CREATE TABLE `tb_payment`  (
  ...
  `order_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单id',
  `product_name` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '产品名称',
  `pay_no` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '第三方返回单号',
  `trade_no` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付流水号',
  `payer_uid` int(20) NOT NULL COMMENT '付款人id',
  `payer_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '付款人姓名',
  `payer_amount` decimal(10, 2) NOT NULL COMMENT '付款方支付金额',
  `order_amount` decimal(10, 2) NOT NULL COMMENT '订单金额',
  `pay_way` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支付方式',
...
CREATE TABLE `tb_refund`  (
  ...
  `user_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '退款人姓名',
  `trade_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '平台退款流水号',
  `refund_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '第三方退款流水号',
...
-- ----------------------------
INSERT INTO `tb_user_verify` VALUES (1, 'xhd', '2019-10-04 06:48:59', '8953359b2b6aa60b3aa37b20bad0bfb6', 'N', 'N');
